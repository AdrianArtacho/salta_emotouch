...
# Mapping of project name → experiment label
project_label_map = {
...
# Duration in seconds for each experiment
...
# Extract records and compute taps per minute
records = []
...
plt.title('Taps per Minute Across Experiments')
