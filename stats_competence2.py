...
# Extract fields for 'Pleyades-public' only
records = []
...
sns.boxplot(
    x='age_range', y='Score', hue='Competence Type', data=melted_df,
    palette=color_map
)
plt.title('Music and Dance Competence by Age Range (All Genders)')
plt.xlabel('Age Range')
plt.ylabel('Competence (1–7 Likert Scale)')
plt.legend(title='Competence Type', labels=['Music', 'Dance'])
plt.tight_layout()
plt.show()
